    ...
    <main className="min-h-screen bg-gray-50 text-gray-900 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed mb-3">When you create an account with us, you must:</p>
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed mb-3">When using 42 PONG, you agree to:</p>
          <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <p className="leading-relaxed mt-3 mb-3">You agree NOT to:</p>
          <ul className="list-disc list-inside space-y-2 ml-4">
