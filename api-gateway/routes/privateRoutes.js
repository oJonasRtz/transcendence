...
const routes = [
	...
	{ method: 'POST', url: '/api/friends/accept', handler: privateControllers.apiAcceptFriend },
	{ method: 'POST', url: '/api/friends/remove', handler: privateControllers.apiRemoveFriend },
